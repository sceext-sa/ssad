...
public class Server {
    public static final String VERSION = "netty http_server version 0.2.0-1 test20170614 0327";
    ...
    public void run() throws Exception {
        ...
        try {
            ...
            // FIXME improve log
            System.err.println("DEBUG: listen at " + _ip + ":" + _port);
