...
reducer = ($$o, action) ->
  switch action.type
    ...
    when ac.EDIT_TASK_SET_DESC
      $$o = $$o.set 'desc', action.payload
    when ac.EDIT_TASK_SET_TIME_PLANNED_START
      $$o = $$o.setIn ['time', 'planned_start'], action.payload
    when ac.EDIT_TASK_SET_TIME_DDL
      $$o = $$o.setIn ['time', 'ddl'], action.payload
    when ac.EDIT_TASK_SET_TIME_DURATION_LIMIT
      $$o = $$o.setIn ['time', 'duration_limit'], action.payload
    when ac.EDIT_TASK_SET_TIME_INTERVAL
      $$o = $$o.setIn ['time', 'interval'], action.payload
    when ac.EDIT_TASK_SET_TIME_BASE
